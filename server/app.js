...
MongoClient.connect('mongodb://localhost:27017/ChatApp', (err, Database) => {     
 //I could have replaced hardcoded url through env variables but due to time constraint, I kept this as it is.
    if(err) {
        console.log(err);
        return false;
    }
